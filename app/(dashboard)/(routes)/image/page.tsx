  ...
  return (
    <div className="text-white">
      <Heading
        ...
        description="Goku AI will create images with your thoughts."
        icon={ImageIcon}
          ...
          <Form {...form}>
            ...
            >
                  ...
                  <FormItem className="col-span-12 lg:col-span-6">
                    <FormControl className="m-0 p-0">
                      <Input
                        ...
                        disabled={isLoading}
                        placeholder="Create an image with Goku"
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
              ...
              <FormField
                ...
                name="amount"
                render={({ field }) => (
                  <FormItem className="col-span-12 text-gray-800 lg:col-span-2">
                    <Select
                      disabled={isLoading}
